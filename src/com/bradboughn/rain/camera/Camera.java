...
//        aabbQue.add(a);
    ...
    public static void queVisAABB()
    {
        if (visAABB != null)
        {
            renderSprite(visAABB.getX(),visAABB.getY(), new Sprite(Tile.TILE_SIZE,Tile.TILE_SIZE, 0xffffffff), true);
        }
    }
    ...
    public static void updateOffsets()
    {
        ...
        else 
        {
            ...
            offsetX = player.getX() - Camera.width/2;
            offsetY = player.getY() - Camera.height/2;
    ...
    {      
        for (int y = startRow; y < endRow; y++)
        {
            ...
            {
                Sprite tileSpr = level.getTile(x, y).sprite;
